...
gene_lst = []
with open ('xgbfeaimp_weight_full_lst.txt', 'r') as file:
    for line in file:
...
for i in range(len(gene_lst)):
    ...
    pathout = f'./cv_score_weight/cv_scoredf_xgb_weight_geneCount_{len(gene_lst)-i}.csv'
...
finaldf.to_csv('10fcv_weight_selection.csv')
